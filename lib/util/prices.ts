...
export const findCheapestRegionPrice = (variants: PricedVariant[], regionId: string) => {
...
export const findCheapestCurrencyPrice = (variants: PricedVariant[], currencyCode: string) => {
...
export const findCheapestPrice = (variants: PricedVariant[], region: Region) => {
