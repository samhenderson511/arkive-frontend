...
export const textStyles = {
  ...
  h4: "font-heading !leading-normal scroll-m-20 text-xl font-headingWeight tracking-tight",
  h5: "font-heading !leading-normal scroll-m-20 text-lg font-headingWeight tracking-tight",
  h6: "font-heading !leading-normal scroll-m-20 text-sm font-headingWeight tracking-tight",
